...
export default function ArrowButton({ href, children, variant = "dark", external }: ArrowButtonProps) {
  const classes = {
  ...
  const className = `group inline-flex items-center gap-4 rounded-none px-6 py-3 text-[11px] font-bold uppercase tracking-[0.18em] transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] active:scale-[0.98] ${classes[variant]}`
